...
var baguetteBox = (function() {
    ...
    var leftArrow = '',
        ...
        closeX = '<svg width="30" height="30">' +
            '<g stroke="#DD001E" stroke-width="4">' +
    ...
    function run(selector, userOptions) {
        ...
        [].forEach.call(
            ...
            function (galleryElement, galleryIndex) {
                ...
                // console.log($(galleryElement).find('a:not(.video)'));
                // console.log(galleryElement.getElementsByTagName('a'));
                var link = $(galleryElement).find('a:not(.video)');
                imagesMap.push(link);
                ...
                [].forEach.call(
                    ...
                    function (imageElement, imageIndex) {
                        if(imageElement.className != 'video'){
    ...
    function buildOverlay() {
        ...
        closeButton.innerHTML = window.overlayCloseText;
